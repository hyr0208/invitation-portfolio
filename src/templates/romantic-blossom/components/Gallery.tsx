...
export function Gallery() {
  ...
  return (
    <Section index="04" eyebrow="Gallery" title="우리의 순간" bleed>
      <div className="grid grid-cols-2 gap-px bg-blossom-line">
        {PHOTOS.map((photo, i) => (
          <button
            key={photo}
            type="button"
      ...
      {active !== null &&
        createPortal(
          <div
            className="animate-fade-in fixed inset-0 z-50 flex items-center justify-center bg-rose-ink"
            onClick={close}
          >
            <img
              key={active}
            ...
            <button
              ...
              className="absolute left-4 flex h-10 w-10 items-center justify-center bg-blossom/90 text-rose-ink"
            >
              ‹
            </button>
            <button
              ...
              className="absolute right-4 flex h-10 w-10 items-center justify-center bg-blossom/90 text-rose-ink"
            >
              ›
            </button>
            <button
              ...
              aria-label="닫기"
              onClick={close}
              className="absolute top-6 right-6 flex h-9 w-9 items-center justify-center bg-blossom/90 text-rose-ink"
            >
              ✕
            </button>
          </div>,
